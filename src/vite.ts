...
const components = [
  ...
  'Tabs', 'Textarea', 'Timeline', 'Notification', 'Toast', 'Tooltip',
  'Tree', 'Autocomplete', 'Breadcrumbs', 'DatePicker', 'FileInput',
  'MultiSelect', 'ToggleGroup',
  'SidebarLayout',
]
 ...
 *
 * Registers unplugin-vue-components so that Construct UI components
 * auto-import in consuming apps.
 *
 * Usage:
 * ```ts
 * // vite.config.ts
